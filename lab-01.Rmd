...
How many tourist attractions are there in the data set? There are 348 
...
# The dates are numeric, the other variables are characters.
...
_How many regions have more than 50 tourist attraction in the data set? (Hint: You will need to tabulate the data before filtering.)_ 1, Scotland.visit
...
```{r Q6}
visitors %>%
     summarise(mean_2022 = mean(n_2022, na.rm = TRUE),
